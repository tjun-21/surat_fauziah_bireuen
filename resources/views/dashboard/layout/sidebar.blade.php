                ...
                <div class="card">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <a href="/cuti"  class="nav-link"><p class="text-dark m-0"> CUTI</p></a>
                        </li>
                        <li class="list-group-item">
                            <a href="/surat"  class="nav-link"><p class="text-dark m-0">LAINNYA</p></a>
                        </li>
                ...
                <div class="card">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            ...
                            <a href="/cuti/karyawan/pns"  class="nav-link"><p class="text-dark m-0">PNS</p></a>
                        </li>
                        <li class="list-group-item">
                            <a href="/cuti/karyawan/p3k"  class="nav-link"><p class="text-dark m-0">P3K</p></a>
                        </li>
                        <li class="list-group-item">
                            <a href="/cuti/karyawan/kontrak"  class="nav-link"><p class="text-dark m-0">KONTRAK</p></a>
                        </li>
                    </ul>
                </div>
            </div>
