...
<div class="col-md-12">
  ...
  <form action="{{ route('updateSettingCuti', ['id' => $dataSetting->id]) }}" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="number" id="kuota_cuti_tahunan" name="kuota_cuti_tahunan" class="form-control" value="{{ $dataSetting->kuota_cuti_tahunan }}" required>
    </div>
    <div class="form-group">
      <label for="cutiN_1">Cuti N-1:</label>
      <input type="number" id="cutiN_1" name="cutiN_1" class="form-control" value="{{ $dataSetting->cutiN_1 }}" required>
    </div>
    <div class="form-group">
      <label for="cutiN_2">Cuti N-2:</label>
      <input type="number" id="cutiN_2" name="cutiN_2" class="form-control" value="{{ $dataSetting->cutiN_2 }}" required>
    </div>
    <div class="form-group">
      <label for="kuota_cuti">Total Kuota Cuti:</label>
      <input type="number" id="kuota_cuti" name="kuota_cuti" class="form-control" value="{{ $dataSetting->kuota_cuti }}" readonly>
    </div>
