    ...
    <div class="row">
        ...
        @if ($pegawais->count())
            ...
            <div class="container mt-3">
                <h3 class="mb-3">DATA KARYAWAN | PNS</h3>
                <div class="row">
                  ...
                  @endif
                  <a href="/pns/create" class="btn btn-primary m-3 mr-2 col-lg-2 "> Tambah Tenaga PNS</a>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="/surat/{{ $pegawai->id}}" class="badge btn-primary" ><span data-feather="info"></span> </a> 
