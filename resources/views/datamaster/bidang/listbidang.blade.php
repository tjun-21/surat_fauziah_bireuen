...
@section('container')
    ...
    @endif
      ...
      <div class="row">
        <a href="/bidang/create" class="btn btn-primary mb-3 col-lg-2 "> Tambah Bidang</a>
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $bidang->nama }}</td>
              <td>
                <a href="{{ route ('bidang.update',$bidang->id )}}/edit" class="badge bg-warning"><span data-feather="edit"></span> </a>
