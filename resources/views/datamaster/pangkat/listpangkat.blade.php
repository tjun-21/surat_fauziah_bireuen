...
<div class="row">
    <a href="/pangkat/create" class="btn btn-primary mb-3 col-lg-2 "> Tambah Pangkat</a>
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $pangkat->nama }}</td>
                <td>
                    <a href="{{ route ('pangkat.update',$pangkat->id )}}/edit" class="badge bg-warning"><span data-feather="edit"></span> </a>

                    <form action="{{ route ('pangkat.destroy',$pangkat->id) }} " method="post" class="d-inline ">
