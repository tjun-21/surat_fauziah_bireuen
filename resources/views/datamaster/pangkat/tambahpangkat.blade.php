  ...
  <div class="col-lg-8 " >
    <form method="post" action="{{ route('pangkat.store') }}">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control @error('pangkat') is-invalid  @enderror " id="nama" name="nama" placeholder="Ex: Kepala Bidang" value="{{ old('nama') }}">
            @error('nama')
...
<button type="submit" class="btn btn-primary mt-3">Tambah pangkat</button>
</form>
