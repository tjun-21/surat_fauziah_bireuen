  ...
  <div class="col-lg-8 " >
    <form method="post" action="{{ route('unit.store') }}">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control @error('unit') is-invalid  @enderror " id="nama" name="nama" placeholder="Ex: Kepala Bidang" value="{{ old('nama') }}">
            @error('nama')
