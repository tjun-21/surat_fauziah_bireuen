    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <p class="text-center mb-1 "><b>
                    <font size='2'>FORMULIR PERMINTAAN DAN PEMBERIAN CUTI</font>
                </b></p>
            ...
            <table cellspacing="0" cellspacing="0" class="p1 mb-2">
                ...
                <tr>
                    ...
                    <td align="center" class="tg">{{ $sisa['n2'] }}</td>
                    <td align="center" class="tg">{{ $sisa['sn2'] }}</td>
                ...
                <tr>
                    ...
                    <td align="center" class="tg">{{ $sisa['n1'] }}</td>
                    <td align="center" class="tg">{{ $sisa['sn1'] }}</td>
                ...
                <tr>
                    ...
                    <td align="center" rowspan="2" class="tg">{{ $sisa['n'] }}</td>
                    <td align="center" rowspan="2" class="tg">{{ $sisa['sn'] }}</td>
